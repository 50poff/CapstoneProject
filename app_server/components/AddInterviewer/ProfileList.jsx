	...
	render() {
		...
		return (
            <div className="row" style={profileListStyle}>
				...
				<Profile interviewerProfiles={this.props.interviewerProfiles} profilesToAddSet={this.props.profilesToAddSet} index={index} key={index} profileId={profile.profile_id}profileName={profile.profile_name} alterProfilesToAddCallback={this.props.alterProfilesToAddCallback}/>
				)}
			</div>
        )
    };
